...
#     try:
#         # Load audio file
#         audio_path = os.path.join('/Users/minabeiramy/workspace/byte_models/cv-corpus-17.0-delta-2024-03-15/en/clips', audio_path)
...
# def main():
#     # Load the TSV file
#     tsv_file = '/Users/minabeiramy/workspace/byte_models/cv-corpus-17.0-delta-2024-03-15/en/validated.tsv'
...
#     chunk_dir = '/Users/minabeiramy/workspace/byte_models/cv-corpus-17.0-delta-2024-03-15/chunk_dir'
...
#         chunk_lists = pool.map(partial_process_audio, [row for index, row in filtered_data.iterrows()])
...
#     # Write text files for each chunk
#     for chunk_data in flat_list:
#         chunk_path = chunk_data['chunk_path']
#         gender = chunk_data['label']
#         txt_filename = chunk_path + ".txt"
...
def process_audio(row, chunk_dir):
    ...
    try:
        ...
        while i < len(audio):
            ...
            # Rename and store chunk details
            #chunk_filename = f"{os.path.splitext(os.path.basename(audio_path))[0]}_chunk{i // int(target_duration_ms)}.mp3"
            chunk_filename = f"{gender}_{os.path.splitext(os.path.basename(audio_path))[0]}_chunk_{i}.mp3"
