...
base_path = "/lustre/orion/csc590/scratch/george-adams/bgpt_110m-wikipedia-ag-news"  # Base path for the project
PRE_WEIGHTS_PATH = f"{base_path}/weights-image.pth"                           # Path to pre-trained weights
WEIGHTS_PATH = f"{base_path}/16-nodes-scratch.pth"                        # Path to save weights
LOGS_PATH = f"{base_path}/legit_runs/simple_math_test1.txt"                              # Path to save logs
...
# PATCH_LENGTH = 81920                                              # Patch Length
