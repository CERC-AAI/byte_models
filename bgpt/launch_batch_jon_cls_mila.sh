...
CONFIG_PATH="/home/mila/j/jonathan.lim/cerc/byte_models/bgpt/configs/config_110M_multimodal_mnist_image_cls.yaml"
...
python train-cls-distributed.py --train-config-path ${CONFIG_PATH}
